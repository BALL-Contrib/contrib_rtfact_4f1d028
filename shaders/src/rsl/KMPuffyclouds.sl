/* I took wave's lead and renamed starfield to KMPuffyclouds.sl -- tal AT renderman DOT org */
	     ...
	     )
{
  ...
  PP = txtscale * P; //PP = txtscale * transform ("shader", P);
