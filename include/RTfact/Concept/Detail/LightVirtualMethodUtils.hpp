 ...
 */
 ...
 /*
    Note: This file is NOT intended to be included directly.
          ...
          RTFACT_LIGHT_GEN_VIRTAL_METHODS is defined in
          RTfact/Concept/Light.hpp.
*/

#define  BOOST_PP_LOCAL_MACRO(n)  RTFACT__LIGHT_GEN_VIRTAL_METHODS(n)
