 ...
 */
 ...
 #ifndef RTFACT_REMOTE__PHONGSHADER_HPP
#define RTFACT_REMOTE__PHONGSHADER_HPP
...
#define RTFACT_REMOTE__PHONG_PARAM_EMISSIVE_COLOR    "emissiveColor"
#define RTFACT_REMOTE__PHONG_PARAM_REFLECTIVE_COLOR  "reflective"
...
#define RTFACT_REMOTE__PHONG_PARAM_ALPHA             "alpha"
...
public:
        ...
        tShaderPtr aShader)
    {
        ...
        else if(name == RTFACT_REMOTE__PHONG_PARAM_EMISSIVE_COLOR)
        {
            const float3& f = boost::get<float3>(value);

            aShader->setEmissiveColor(Vec3f1(f.x, f.y, f.z));
        }
        else if(name == RTFACT_REMOTE__PHONG_PARAM_REFLECTIVE_COLOR)
        {
            const float3& f = boost::get<float3>(value);
        ...
        else if(name == RTFACT_REMOTE__PHONG_PARAM_ALPHA)
        {
            aShader->setTransparency(1-boost::get<float>(value));
        }
        ...
        tShaderPtr aShader)
    {
        ...
        {
            value = 1-aShader->getTransparency();
        }
        else if(name == RTFACT_REMOTE__PHONG_PARAM_MAX_DEPTH)
        {
        ...
        const std::string &name)
    {
        return
            ...
            name == RTFACT_REMOTE__PHONG_PARAM_EMISSIVE_COLOR ||
            name == RTFACT_REMOTE__PHONG_PARAM_REFLECTIVE_COLOR ||
            name == RTFACT_REMOTE__PHONG_PARAM_AMBIENT_INTENSITY ||
            name == RTFACT_REMOTE__PHONG_PARAM_SHININESS ||
            name == RTFACT_REMOTE__PHONG_PARAM_ALPHA ||
        ...
        std::vector<ParamInfo> &infos)
    {
        ...
        infos.push_back(ParamInfo(
            RTFACT_REMOTE__PHONG_PARAM_EMISSIVE_COLOR,
            FLOAT3_VALUE));

        infos.push_back(ParamInfo(
            RTFACT_REMOTE__PHONG_PARAM_REFLECTIVE_COLOR,
            FLOAT3_VALUE));
        ...
        infos.push_back(ParamInfo(
            RTFACT_REMOTE__PHONG_PARAM_MAX_DEPTH,
            INT_VALUE));
...
#endif // RTFACT_REMOTE__PHONGSHADER_HPP
